...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1034.9590405360207; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 3172.851572709176; // x position of the perpendicular encoder (in tick units)
    }
